...
parser = argparse.ArgumentParser(description='MDou: PyTorch DouDizhu AI')

# General Settings
parser.add_argument('--xpid', default='MDou',
                    help='Experiment id (default: MDou)')
...
parser.add_argument('--savedir', default='mdou_checkpoints',
